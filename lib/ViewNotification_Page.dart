...
class Notifiocation_view_Page extends StatefulWidget {
  const Notifiocation_view_Page({Key? key}) : super(key: key);

  @override
  State<Notifiocation_view_Page> createState() => _Notifiocation_view_PageState();
}

class _Notifiocation_view_PageState extends State<Notifiocation_view_Page> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      StreamBuilder<QuerySnapshot>(
        stream:FirebaseFirestore.instance.collection("dailyupdates").orderBy("timestamp").snapshots() ,
  ...
  dailyupdat(docid) async {
    FirebaseFirestore.instance.collection("dailyupdates").doc(docid).delete();
